...
type AddRecipeFormData = yup.InferType<typeof addRecipeSchema>;
...
const AddRecipe = () => {
  ...
  return (
    <Container>
      <div className="py-10 md:py-14 2xl:py-20">
        ...
        >
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* Ingredients */}
            <div className="space-y-4">
              <Subtitle className="uppercase">Ingredients</Subtitle>
            ...
            {/* Preparation */}
            <div className="space-y-3">
              <Subtitle className="uppercase">Recipe preparation</Subtitle>
              <div>
                <textarea
