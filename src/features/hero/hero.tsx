  ...
  return (
    <section className="position-relative z-[1] mt-[-60px] pt-1 xs:pt-2 md:mt-[-90px] md:pt-4 2xl:pt-5">
      <div className="mx-auto w-full px-1 xs:w-[100%] xs:px-2 md:px-4 2xl:w-[1440px] 2xl:px-5">
        <div className="max-2xl:pb-[94px] max-2xl:pt-[217px] max-md:pb-[100px] max-md:pt-[194px] relative flex flex-col items-center overflow-hidden rounded-2xl bg-black pb-[81px] pt-[140px] text-center text-white md:pt-[147px]">
